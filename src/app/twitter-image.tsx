...
export default async function Image() {
  ...
  return new ImageResponse(
      ...
      >
        <div
          style={{
            ...
            right: 0,
            height: 6,
            background: "linear-gradient(90deg, #E8A445 0%, #D4932E 50%, #E8A445 100%)",
          }}
        />
        <div
          style={{
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            ...
            <div style={{ width: 18, height: 6, borderRadius: "0 0 6px 6px", background: "white", marginTop: 4 }} />
          </div>
        </div>
        <div style={{ fontFamily: '"Press Start 2P"', fontSize: 56, color: "#E8A445", letterSpacing: 4, marginBottom: 16 }}>
          vibeclod
        </div>
        ...
        <div style={{ display: "flex", gap: 40 }}>
          {["8 Worlds", "40 Levels", "Real Code"].map((stat) => (
            ...
            >
              <div style={{ fontFamily: '"Press Start 2P"', fontSize: 13, color: "rgba(255,255,255,0.8)" }}>
                {stat}
              </div>
            </div>
          ))}
        </div>
        <div style={{ position: "absolute", bottom: 30, fontFamily: '"Press Start 2P"', fontSize: 11, color: "rgba(255,255,255,0.3)" }}>
          vibeclod.com
        </div>
      </div>
    ),
    {
      ...size,
      fonts: [{ name: "Press Start 2P", data: fontData, style: "normal" as const, weight: 400 as const }],
    }
  );
}
