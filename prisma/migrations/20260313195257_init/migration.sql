...
-- CreateEnum
CREATE TYPE "SubmissionStatus" AS ENUM ('PENDING', 'CHECKING', 'PASSED', 'FAILED', 'ERROR');
...
-- CreateIndex
CREATE UNIQUE INDEX "LevelCompletion_userId_levelId_key" ON "LevelCompletion"("userId", "levelId");
